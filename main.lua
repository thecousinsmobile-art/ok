-- ==========================================
-- GITHUB AUTHENTICATION & KEY SYSTEM (FIXED)
-- ==========================================
local Players = game:GetService("Players")
local player = Players.LocalPlayer

local GITHUB_WHITELIST_URL = "https://raw.githubusercontent.com/thecousinsmobile-art/ok/main/whitelist.lua"
local GITHUB_DASH_SCRIPT_URL = "https://raw.githubusercontent.com/thecousinsmobile-art/ok/main/dash.lua"
...
-- Load your dash script from GitHub once verified
local dashSuccess, dashScript = pcall(function()
    return game:HttpGet(GITHUB_DASH_SCRIPT_URL)
end)

if dashSuccess then
    loadstring(dashScript)()
else
    warn("Failed to load dash script from GitHub.")
end
